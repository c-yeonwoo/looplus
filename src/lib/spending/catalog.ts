...
> = {
  food: { label: "식비", icon: "cart", color: "#a88b5c" },
  cafe: { label: "카페", icon: "sun", color: "#c4a574" },
  transport: { label: "교통", icon: "layers", color: "#5b7c6e" },
  ...
  subscription: { label: "구독", icon: "loop", color: "#7d6644" },
  insurance: { label: "보험", icon: "shield", color: "#3a5147" },
